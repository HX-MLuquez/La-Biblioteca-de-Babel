...
const hyperLibreriaCaracteres = ["a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "ñ", "o", "p", "q", "r", "s", "t", "u", "v", "w", "x", "y", "z", "á", "é", "í", "ó", "ú", ".", ",", ";", "_", "-", ":", "(", ")", "¿", "?", "!", "¡", "=", "1", "2", "3", "4", "5", "6", "7", "8", "9", "0", "A", "B", "C", "D", "E", "F", "G", "H", "I", "J", "K", "L", "M", "N", "Ñ", "O", "P", "Q", "R", "S", "T", "U", "V", "W", "X", "Y", "Z", " "]; // tiene 83 caracteres
// tiene 83 caracteres
...
console.dir(laBibliotecaDeBabel(cantidadCaracteres, libreriaCaracteres), { 'maxArrayLength': null });
...
const tipoCaracteresFrases = ["a","m","y"," "]; // tiene 4 tipos de caracteres
const cantidadCaracteresFrases = 6;
// contiene 4.096 (que es de 4^6) de posibilidades.
console.dir(laBibliotecaDeBabel(cantidadCaracteresFrases, tipoCaracteresFrases), { 'maxArrayLength': null });
